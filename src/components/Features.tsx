...
const Features: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      title: "No Sign Up",
      description: "Start using IntelliKey instantly. We don't require an account or email to generate secure passwords."
    },
    {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-[20px] font-medium text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            IntelliKey is built with privacy and simplicity as the core principles. 
